...
<script>
import { settlementCoacher, settlementCoacherDetail } from '@/api/settlement'
...
export default {
  ...
  methods: {
    ...
    getListDetail() {
      ...
      settlementCoacherDetail(this.listDetailValue.yearmonth, this.listDetailValue.userId, this.listQueryDeailFilter)
        .then((res) => {
    ...
    getList() {
      ...
      settlementCoacher(this.listQuery).then(response => {
